...
import 'enseignant_page.dart';

class RedirectPage extends StatelessWidget {
  final String role;

  const RedirectPage({super.key, this.role = 'etudiant'});
  ...
  Widget build(BuildContext context) {
    ...
    if (isAuthenticated) {
      ...
      if (roleLower == 'admin') return const AdminDashboard();
      if (roleLower == 'enseignant') return const EnseignantDashboard();
